...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-07-2024 a las 21:10:08
...
(3, 2, 28, 'AUXILIO DE TRANSPORTE', '81000', 5),
(4, 2, 19, 'Bono', '1000000', 6),
(5, 2, 28, 'AUXILIO DE TRANSPORTE', '81000', 7);
...
(2, 'LUIS RODRIGUEZ', 1, 1143567890, 9, 7, '1500000'),
(3, 'Meissy Voos', 1, 123456789, 1, 4, '2400000');
...
INSERT INTO `usuarios` (`id`, `id_empleados`, `username`, `password`, `profile`) VALUES
(2, 1, 'admin', '$2y$10$/cb9nTdv.Jz93HLLynhK3uqaa8NPM0CIKxfPH6kTKtCiRoyogkDxy', '1'),
(3, 2, '1143567890', '$2y$10$UnfLKMCkxZcs1adWsG2wXe1eza01nA8a6Bk/qQN5/BueY5Cesmyyy', '0'),
(4, 1, '1143146114', '$2y$10$vL1h7olHoYDzM/oMKmrfau//uXhAjlse8hHAuW2bMtgr6Y2REllA6', '1');
...
(5, 2, '2024-06-24', '81000.00', '70000.00', '761000.00', 6, 2, 2, 750000),
(6, 2, '2024-06-24', '1000000.00', '86000.00', '1664000.00', 7, 2, 1, 750000),
(7, 2, '2024-07-02', '81000.00', '0', '831000.00', 12, 3, 1, 750000);
...
--
ALTER TABLE `deducciones`
  MODIFY `id_deduccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `devengados`
--
ALTER TABLE `devengados`
  MODIFY `id_devengados` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `volante_de_pago`
  MODIFY `id_volante_pago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
